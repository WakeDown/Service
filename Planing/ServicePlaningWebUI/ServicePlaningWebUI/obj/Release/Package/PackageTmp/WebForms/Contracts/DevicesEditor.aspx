    ...
    <div class="panel-body">
        ...
        <div class="form-horizontal val-form" role="form">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <asp:DropDownList ID="ddlServiceIntervals" runat="server" CssClass="form-control" placeholder="Интервал">
                    </asp:DropDownList>
                    <span class="help-block">
                                ...
                                <ItemTemplate>
                                    ...
                                    <tr>
                                        ...
                                        <td class="schedule-field">
                                            <asp:Panel ID="pnlSchedMonth1" runat="server" CssClass="disabled">1
                                            <asp:HiddenField ID="hfSchedMonth1" runat="server" /></asp:Panel>
                                        </td>
                                        <td class="schedule-field">
                                            <asp:Panel ID="pnlSchedMonth2" runat="server" CssClass="disabled">2
                                            <asp:HiddenField ID="hfSchedMonth2" runat="server" /></asp:Panel>
                                        </td>
                                        <td class="schedule-field">
                                            <asp:Panel ID="pnlSchedMonth3" runat="server" CssClass="disabled">3
                                            <asp:HiddenField ID="hfSchedMonth3" runat="server" /></asp:Panel>
                                        </td>
                                        <td class="schedule-field">
                                            <asp:Panel ID="pnlSchedMonth4" runat="server" CssClass="disabled">4
                                            <asp:HiddenField ID="hfSchedMonth4" runat="server" /></asp:Panel>
                                        </td>
                                        <td class="schedule-field">
                                            <asp:Panel ID="pnlSchedMonth5" runat="server" CssClass="disabled">5
                                            <asp:HiddenField ID="hfSchedMonth5" runat="server" /></asp:Panel>
                                        </td>
                                        <td class="schedule-field">
                                            <asp:Panel ID="pnlSchedMonth6" runat="server" CssClass="disabled">6
                                            <asp:HiddenField ID="hfSchedMonth6" runat="server" /></asp:Panel>
                                        </td>
                                        <td class="schedule-field">
                                            <asp:Panel ID="pnlSchedMonth7" runat="server" CssClass="disabled">7
                                            <asp:HiddenField ID="hfSchedMonth7" runat="server" /></asp:Panel>
                                        </td>
                                        <td class="schedule-field">
                                            <asp:Panel ID="pnlSchedMonth8" runat="server" CssClass="disabled">8
                                            <asp:HiddenField ID="hfSchedMonth8" runat="server" /></asp:Panel>
                                        </td>
                                        <td class="schedule-field">
                                            <asp:Panel ID="pnlSchedMonth9" runat="server" CssClass="disabled">9
                                            <asp:HiddenField ID="hfSchedMonth9" runat="server" /></asp:Panel>
                                        </td>
                                        <td class="schedule-field">
                                            <asp:Panel ID="pnlSchedMonth10" runat="server" CssClass="disabled">10
                                            <asp:HiddenField ID="hfSchedMonth10" runat="server" /></asp:Panel>
                                        </td>
                                        <td class="schedule-field">
                                            <asp:Panel ID="pnlSchedMonth11" runat="server" CssClass="disabled">11
                                            <asp:HiddenField ID="hfSchedMonth11" runat="server" /></asp:Panel>
                                        </td>
                                        <td class="schedule-field">
                                            <asp:Panel ID="pnlSchedMonth12" runat="server" CssClass="disabled">12
                                            <asp:HiddenField ID="hfSchedMonth12" runat="server" /></asp:Panel>
                                        </td>
                                    </tr>
                                </ItemTemplate>
                                <FooterTemplate>
...
<%--                        </ContentTemplate>
            ...
            <div class="form-group">
                <label class="col-sm-2 control-label required-mark" for='<%=txtAddress.ClientID %>'>Адрес</label>
                <div class="col-sm-10">
            ...
            <div class="form-group">
                <label class="col-sm-2 control-label required-mark" for='<%=txtContactName.ClientID %>'>Конт. лицо</label>
                <div class="col-sm-10">
