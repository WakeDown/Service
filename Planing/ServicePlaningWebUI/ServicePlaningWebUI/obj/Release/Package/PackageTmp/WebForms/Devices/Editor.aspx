        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">
                <div class="input-group">
                    <asp:TextBox ID="txtSerialNum" runat="server" class="form-control" MaxLength="50"></asp:TextBox>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">
                <div class="input-group">
                    ...
                    <asp:TextBox ID="txtCounter" runat="server" class="form-control" MaxLength="10"></asp:TextBox>
                </div>
                <span class="help-block">
