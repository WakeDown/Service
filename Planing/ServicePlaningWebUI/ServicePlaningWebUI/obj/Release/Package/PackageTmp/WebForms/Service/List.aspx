    ...
    <div class="form-horizontal val-form" role="form">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <div class="input-group full-width">
                    <span class="input-group-btn width-20">
                        <asp:TextBox ID="txtContractorSelection" runat="server" class="form-control width-20 input-sm" placeholder="поиск" MaxLength="30"></asp:TextBox>
                    </span>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphList" runat="server">
    ...
    <h5><span class="label label-default">Выбрано записей:
            ...
            <asp:TemplateField ItemStyle-CssClass="min-width nowrap">
                <ItemTemplate>
                   <a href='<%# GetRedirectUrlWithParams(String.Format("ctrid={1}&id={0}", Eval("id_service_claim"), Eval("id_contract")), false, FormUrl) %>' class="btn btn-link" data-toggle="tooltip" title="редактировать"  <%# DisableIfDoneStr(Eval("claim_status").ToString()) %>><i class="fa fa-edit fa-lg"></i></a>
                    <a href='<%# GetRedirectUrlWithParams(String.Format("id={0}", Eval("id_service_claim")), false, FormCameUrl) %>' class="btn btn-link" data-toggle="tooltip" title="отметка об обслуживании" <%# DisableIfDoneStr(Eval("claim_status").ToString()) %>><i class="fa fa-cog fa-lg"></i></a>
                </ItemTemplate>
            </asp:TemplateField>
           <%-- <asp:TemplateField>
                <ItemTemplate>
            ...
            <asp:TemplateField ItemStyle-CssClass="min-width">
                <ItemTemplate>
                   <asp:LinkButton ID="btnDelete" runat="server" OnClick="btnDelete_OnClick" CommandArgument='<%#Eval("id_service_claim") %>' OnClientClick="return DeleteConfirm('заявку')" CssClass="btn btn-link" data-toggle="tooltip" title="удалить"><i class="fa fa-trash-o fa-lg"></i></asp:LinkButton>
                </ItemTemplate>
            </asp:TemplateField>
             </Columns>
    </asp:GridView>
