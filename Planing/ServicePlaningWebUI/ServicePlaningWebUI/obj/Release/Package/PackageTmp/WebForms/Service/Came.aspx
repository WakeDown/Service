        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                ...
                <asp:UpdatePanel ID="upClaimList" runat="server">
                    <ContentTemplate>
                        <asp:TextBox ID="txtClaimSelection" runat="server" class="form-control input-sm" placeholder="поиск" MaxLength="50" OnTextChanged="txtClaimSelection_TextChanged" AutoPostBack="True"></asp:TextBox>
