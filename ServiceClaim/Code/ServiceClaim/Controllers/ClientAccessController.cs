...
namespace ServiceClaim.Controllers
{
    public class ClientAccessController : BaseController
    {
        ...
        {
            if (!CurUser.InGroup(AdGroup.ServiceClaimClientAccess, AdGroup.ServiceControler)) RedirectToAction("AccessDenied", "Error");
        ...
        {
            if (!CurUser.InGroup(AdGroup.ServiceClaimClientAccess)) RedirectToAction("AccessDenied", "Error");
            try
            {
